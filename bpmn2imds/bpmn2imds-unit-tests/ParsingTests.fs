...
module tests = 
    ...
    type bpmn2imds_unit_tests () =
        ...
        member this.ParserShouldWorkCorrectlyForBPMNDiagrams() =
            ...
            elements |> should contain (IntermediateEvent ("Event_11maord","Process_16buli2",Point (320,340)))
            ...
            flows |> should contain (SequenceFlow (IntermediateEvent ("Event_11maord","Process_16buli2",Point (320,340)), EndEvent ("Event_1onr7og","Process_16buli2",Point (410,420)),"Flow_1up2kuu", Point (320,358),Point (320,358)))
