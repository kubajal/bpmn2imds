...
type Node = 
    | XOR of id: string * parent: string * middle: Point
    | AND of id: string * parent: string * middle: Point
    | Start of id: string * parent: string * middle: Point
    | End of id: string * parent: string * middle: Point
